...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        // Create the Reviewer Completion Agent: "Joker", with simple kernel
        ...
        await AgentGroupChatAsync(agent: groupChatAgent);
    ...
    private static async Task AgentGroupChatAsync(object agent)
    {
