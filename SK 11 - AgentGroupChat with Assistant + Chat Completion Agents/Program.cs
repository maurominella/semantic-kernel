    ...
    private static async Task Main(string[] args)
    {
        ...
        KernelFunction terminationFunction =
            AgentGroupChat.CreatePromptFunctionForStrategy(
                $$$"""
                Examine the RESPONSE and announce the magic number included in it.
                If the magic number is a multiple of four, respond with the single word: {{{TerminationToken}}}.
                If it is **NOT** a multiple of four, respond with the name an animal generated by the {{{statistician_agent.Name}}}.
                RESPONSE:
                {{$lastmessage}}
                """,
        ...
        KernelFunction selectionFunction =
            AgentGroupChat.CreatePromptFunctionForStrategy(
                $$$"""
                Examine the provided RESPONSE and return only the next participant name.
        ...
        var groupChatAgent = new AgentGroupChat(statistician_agent, joker_agent, reviewer_agent)
        {
